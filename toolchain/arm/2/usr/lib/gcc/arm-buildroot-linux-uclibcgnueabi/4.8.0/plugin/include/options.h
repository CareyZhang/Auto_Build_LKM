...
enum opt_code
{
  ...
  OPT_Wc_binding_type = 176,                 /* -Wc-binding-type */
  ...
  OPT_Wliteral_suffix = 257,                 /* -Wliteral-suffix */
  ...
  OPT_Wrealloc_lhs = 311,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 312,                /* -Wrealloc-lhs-all */
  ...
  OPT_Wuseless_cast = 384,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 385,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 386,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 387,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 388,   /* -Wvector-operation-performance */
  OPT_Wvla = 389,                            /* -Wvla */
  ...
  OPT_Wzero_as_null_pointer_constant = 393,  /* -Wzero-as-null-pointer-constant */
  OPT_Xassembler = 394,                      /* -Xassembler */
  OPT_Xlinker = 395,                         /* -Xlinker */
  OPT_Xpreprocessor = 396,                   /* -Xpreprocessor */
  OPT_Z = 397,                               /* -Z */
  OPT_ansi = 398,                            /* -ansi */
  OPT_aux_info = 399,                        /* -aux-info */
  /* OPT_aux_info_ = 400, */                 /* -aux-info= */
  OPT_auxbase = 401,                         /* -auxbase */
  OPT_auxbase_strip = 402,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 403, */             /* -bootclasspath */
  OPT_c = 404,                               /* -c */
  ...
  OPT_faggressive_function_elimination = 425,/* -faggressive-function-elimination */
  OPT_falign_commons = 426,                  /* -falign-commons */
  OPT_falign_functions = 427,                /* -falign-functions */
  OPT_falign_functions_ = 428,               /* -falign-functions= */
  OPT_falign_jumps = 429,                    /* -falign-jumps */
  OPT_falign_jumps_ = 430,                   /* -falign-jumps= */
  OPT_falign_labels = 431,                   /* -falign-labels */
  OPT_falign_labels_ = 432,                  /* -falign-labels= */
  OPT_falign_loops = 433,                    /* -falign-loops */
  OPT_falign_loops_ = 434,                   /* -falign-loops= */
  OPT_fall_intrinsics = 435,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 436, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 437,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 438,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 439, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 440, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 441, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 442, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 443, */  /* -fargument-noalias-global */
  OPT_fasm = 444,                            /* -fasm */
  OPT_fassert = 445,                         /* -fassert */
  OPT_fassociative_math = 446,               /* -fassociative-math */
  OPT_fassume_compiled = 447,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 448,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 449,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 450,                   /* -fauto-inc-dec */
  OPT_fautomatic = 451,                      /* -fautomatic */
  OPT_faux_classpath = 452,                  /* -faux-classpath */
  OPT_fbackslash = 453,                      /* -fbackslash */
  OPT_fbacktrace = 454,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 455,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 456,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 457,              /* -fbootstrap-classes */
  OPT_fbounds_check = 458,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 459,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 460,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 461,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 462,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 463,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 464,                /* -fbuilding-libgcc */
  ...
  OPT_fcheck_array_temporaries = 470,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 471,                /* -fcheck-data-deps */
  OPT_fcheck_new = 472,                      /* -fcheck-new */
  OPT_fcheck_references = 473,               /* -fcheck-references */
  OPT_fcheck_ = 474,                         /* -fcheck= */
  OPT_fclasspath_ = 475,                     /* -fclasspath= */
  OPT_fcoarray_ = 476,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 477,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 478,                         /* -fcommon */
  OPT_fcompare_debug = 479,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 480,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 481,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 482,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 483,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 484,                  /* -fcond-mismatch */
  OPT_fconserve_space = 485,                 /* -fconserve-space */
  OPT_fconserve_stack = 486,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 487,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 488,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 489,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 490,          /* -fconvert=little-endian */
  OPT_fconvert_native = 491,                 /* -fconvert=native */
  OPT_fconvert_swap = 492,                   /* -fconvert=swap */
  OPT_fcprop_registers = 493,                /* -fcprop-registers */
  OPT_fcray_pointer = 494,                   /* -fcray-pointer */
  OPT_fcrossjumping = 495,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 496,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 497, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 498,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 499,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 500,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 501,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 502,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 503,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 504,                       /* -fdbg-cnt= */
  OPT_fdce = 505,                            /* -fdce */
  OPT_fdebug_cpp = 506,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 507,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 508,            /* -fdebug-types-section */
  ...
  OPT_fdiagnostics_show_caret = 518,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 519,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 520,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 521,                /* -fdirectives-only */
  OPT_fdisable_ = 522,                       /* -fdisable- */
  OPT_fdisable_assertions = 523,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 524,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 525,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 526,         /* -fdollars-in-identifiers */
  OPT_fdse = 527,                            /* -fdse */
  OPT_fdump_ = 528,                          /* -fdump- */
  /* OPT_fdump_core = 529, */                /* -fdump-core */
  OPT_fdump_final_insns = 530,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 531,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 532,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 533,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 534,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 535,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 536,                /* -fdump-parse-tree */
  OPT_fdump_passes = 537,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 538,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 539,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 540,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 541,                 /* -fearly-inlining */
  OPT_felide_constructors = 542,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 543,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 544, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 545,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 546,        /* -femit-class-debug-always */
  OPT_femit_class_file = 547,                /* -femit-class-file */
  OPT_femit_class_files = 548,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 549,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 550,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 551,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 552,                        /* -fenable- */
  OPT_fenable_assertions = 553,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 554,             /* -fenable-assertions= */
  ...
  OPT_ffilelist_file = 569,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 570,               /* -ffinite-math-only */
  OPT_ffixed_ = 571,                         /* -ffixed- */
  OPT_ffixed_form = 572,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 573,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 574,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 575,                    /* -ffloat-store */
  OPT_ffor_scope = 576,                      /* -ffor-scope */
  /* OPT_fforce_addr = 577, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 578,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 579,              /* -fforward-propagate */
  OPT_ffp_contract_ = 580,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 581,                      /* -ffpe-trap= */
  OPT_ffree_form = 582,                      /* -ffree-form */
  OPT_ffree_line_length_ = 583,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 584,          /* -ffree-line-length-none */
  OPT_ffreestanding = 585,                   /* -ffreestanding */
  OPT_ffriend_injection = 586,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 587,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 588,                   /* -ffunction-cse */
  OPT_ffunction_sections = 589,              /* -ffunction-sections */
  OPT_fgcse = 590,                           /* -fgcse */
  OPT_fgcse_after_reload = 591,              /* -fgcse-after-reload */
  OPT_fgcse_las = 592,                       /* -fgcse-las */
  OPT_fgcse_lm = 593,                        /* -fgcse-lm */
  OPT_fgcse_sm = 594,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 595,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 596,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 597,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 598,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 599,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 600,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 601,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 602,                   /* -fgo-optimize- */
  OPT_fgo_prefix_ = 603,                     /* -fgo-prefix= */
  OPT_fgraphite = 604,                       /* -fgraphite */
  OPT_fgraphite_identity = 605,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 606,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 607, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 608, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 609,           /* -fhash-synchronization */
  /* OPT_fhelp = 610, */                     /* -fhelp */
  /* OPT_fhelp_ = 611, */                    /* -fhelp= */
  /* OPT_fhonor_std = 612, */                /* -fhonor-std */
  OPT_fhosted = 613,                         /* -fhosted */
  /* OPT_fhuge_objects = 614, */             /* -fhuge-objects */
  OPT_fident = 615,                          /* -fident */
  OPT_fif_conversion = 616,                  /* -fif-conversion */
  OPT_fif_conversion2 = 617,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 618,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 619,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 620,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 621,             /* -fimplicit-templates */
  OPT_findirect_classes = 622,               /* -findirect-classes */
  OPT_findirect_dispatch = 623,              /* -findirect-dispatch */
  OPT_findirect_inlining = 624,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 625,         /* -finhibit-size-directive */
  OPT_finit_character_ = 626,                /* -finit-character= */
  OPT_finit_integer_ = 627,                  /* -finit-integer= */
  OPT_finit_local_zero = 628,                /* -finit-local-zero */
  OPT_finit_logical_ = 629,                  /* -finit-logical= */
  OPT_finit_real_ = 630,                     /* -finit-real= */
  OPT_finline = 631,                         /* -finline */
  OPT_finline_atomics = 632,                 /* -finline-atomics */
  OPT_finline_functions = 633,               /* -finline-functions */
  OPT_finline_functions_called_once = 634,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 635, */            /* -finline-limit- */
  OPT_finline_limit_ = 636,                  /* -finline-limit= */
  OPT_finline_small_functions = 637,         /* -finline-small-functions */
  OPT_finput_charset_ = 638,                 /* -finput-charset= */
  ...
  OPT_floop_block = 668,                     /* -floop-block */
  /* OPT_floop_flatten = 669, */             /* -floop-flatten */
  OPT_floop_interchange = 670,               /* -floop-interchange */
  /* OPT_floop_optimize = 671, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 672,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 673,                /* -floop-strip-mine */
  OPT_flto = 674,                            /* -flto */
  OPT_flto_compression_level_ = 675,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 676,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 677,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 678,             /* -flto-partition=none */
  OPT_flto_report = 679,                     /* -flto-report */
  OPT_flto_ = 680,                           /* -flto= */
  OPT_fltrans = 681,                         /* -fltrans */
  OPT_fltrans_output_list_ = 682,            /* -fltrans-output-list= */
  OPT_fmain_ = 683,                          /* -fmain= */
  OPT_fmath_errno = 684,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 685,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 686,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 687,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 688,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 689,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 690,                     /* -fmem-report */
  OPT_fmerge_all_constants = 691,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 692,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 693,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 694,                /* -fmessage-length= */
  OPT_fmodule_private = 695,                 /* -fmodule-private */
  OPT_fmodulo_sched = 696,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 697,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 698,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 699,                  /* -fms-extensions */
  OPT_fmudflap = 700,                        /* -fmudflap */
  OPT_fmudflapir = 701,                      /* -fmudflapir */
  OPT_fmudflapth = 702,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 703, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 704, */                  /* -fnew-abi */
  OPT_fnext_runtime = 705,                   /* -fnext-runtime */
  OPT_fnil_receivers = 706,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 707,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 708,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 709, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 710,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 711,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 712,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 713,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 714,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 715,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 716,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 717,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 718,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 719,             /* -fomit-frame-pointer */
  OPT_fopenmp = 720,                         /* -fopenmp */
  OPT_foperator_names = 721,                 /* -foperator-names */
  OPT_foptimize_register_move = 722,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 723,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 724,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 725,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 726, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 727,              /* -foutput-class-dir= */
  OPT_fpack_derived = 728,                   /* -fpack-derived */
  OPT_fpack_struct = 729,                    /* -fpack-struct */
  OPT_fpack_struct_ = 730,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 731,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 732,              /* -fpcc-struct-return */
  OPT_fpch_deps = 733,                       /* -fpch-deps */
  OPT_fpch_preprocess = 734,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 735,                     /* -fpeel-loops */
  OPT_fpeephole = 736,                       /* -fpeephole */
  OPT_fpeephole2 = 737,                      /* -fpeephole2 */
  OPT_fpermissive = 738,                     /* -fpermissive */
  OPT_fpic = 739,                            /* -fpic */
  OPT_fpie = 740,                            /* -fpie */
  OPT_fplan9_extensions = 741,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 742,                    /* -fplugin-arg- */
  OPT_fplugin_ = 743,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 744,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 745,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 746,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 747,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 748,                   /* -fpreprocessed */
  OPT_fpretty_templates = 749,               /* -fpretty-templates */
  OPT_fprofile = 750,                        /* -fprofile */
  OPT_fprofile_arcs = 751,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 752,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 753,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 754,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 755,              /* -fprofile-generate= */
  ...
  OPT_freal_4_real_10 = 763,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 764,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 765,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 766,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 767,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 768,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 769,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 770,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 771,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 772,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 773,                /* -frecord-marker=8 */
  OPT_frecursive = 774,                      /* -frecursive */
  OPT_freduced_reflection = 775,             /* -freduced-reflection */
  OPT_free = 776,                            /* -free */
  OPT_freg_struct_return = 777,              /* -freg-struct-return */
  OPT_fregmove = 778,                        /* -fregmove */
  OPT_frename_registers = 779,               /* -frename-registers */
  OPT_freorder_blocks = 780,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 781,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 782,              /* -freorder-functions */
  OPT_frepack_arrays = 783,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 784,           /* -freplace-objc-classes */
  OPT_frepo = 785,                           /* -frepo */
  OPT_frequire_return_statement = 786,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 787,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 788, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 789,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 790,                    /* -fresolution= */
  ...
  OPT_fsched_pressure_algorithm_ = 800,      /* -fsched-pressure-algorithm= */
  OPT_fsched_rank_heuristic = 801,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 802,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 803,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 804,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 805,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 806,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 807,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 808,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 809,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 810,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 811,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 812, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 813,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 814,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 815,              /* -fsecond-underscore */
  OPT_fsection_anchors = 816,                /* -fsection-anchors */
  /* OPT_fsee = 817, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 818,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 819,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 820, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 821,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 822,          /* -fselective-scheduling2 */
  OPT_fshort_double = 823,                   /* -fshort-double */
  OPT_fshort_enums = 824,                    /* -fshort-enums */
  OPT_fshort_wchar = 825,                    /* -fshort-wchar */
  OPT_fshow_column = 826,                    /* -fshow-column */
  OPT_fshrink_wrap = 827,                    /* -fshrink-wrap */
  OPT_fsign_zero = 828,                      /* -fsign-zero */
  OPT_fsignaling_nans = 829,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 830,               /* -fsigned-bitfields */
  OPT_fsigned_char = 831,                    /* -fsigned-char */
  OPT_fsigned_zeros = 832,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 833,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 834,               /* -fsource-filename= */
  OPT_fsource_ = 835,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 836,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 837,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 838,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 839, */                 /* -fsquangle */
  OPT_fstack_arrays = 840,                   /* -fstack-arrays */
  /* OPT_fstack_check = 841, */              /* -fstack-check */
  OPT_fstack_check_ = 842,                   /* -fstack-check= */
  OPT_fstack_limit = 843,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 844,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 845,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 846,                /* -fstack-protector */
  OPT_fstack_protector_all = 847,            /* -fstack-protector-all */
  OPT_fstack_usage = 848,                    /* -fstack-usage */
  OPT_fstats = 849,                          /* -fstats */
  OPT_fstore_check = 850,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 851, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 852,                /* -fstrict-aliasing */
  ...
  OPT_ftemplate_backtrace_limit_ = 861,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 862, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 863,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 864,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 865, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 866,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 867,             /* -fthreadsafe-statics */
  OPT_ftime_report = 868,                    /* -ftime-report */
  OPT_ftls_model_ = 869,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 870,               /* -ftoplevel-reorder */
  OPT_ftracer = 871,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 872,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 873,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 874,                  /* -ftrapping-math */
  OPT_ftrapv = 875,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 876,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 877,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 878,                       /* -ftree-ccp */
  OPT_ftree_ch = 879,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 880,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 881,                /* -ftree-copyrename */
  OPT_ftree_cselim = 882,                    /* -ftree-cselim */
  OPT_ftree_dce = 883,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 884,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 885,                       /* -ftree-dse */
  OPT_ftree_forwprop = 886,                  /* -ftree-forwprop */
  OPT_ftree_fre = 887,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 888,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 889,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 890,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 891,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 892,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 893,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 894, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 895,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 896,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 897,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 898,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 899,                   /* -ftree-phiprop */
  OPT_ftree_pre = 900,                       /* -ftree-pre */
  OPT_ftree_pta = 901,                       /* -ftree-pta */
  OPT_ftree_reassoc = 902,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 903, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 904,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 905,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 906,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 907,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 908, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 909, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 910,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 911,                /* -ftree-tail-merge */
  OPT_ftree_ter = 912,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 913,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 914,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 915,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 916,                       /* -ftree-vrp */
  OPT_funderscoring = 917,                   /* -funderscoring */
  OPT_funit_at_a_time = 918,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 919,               /* -funroll-all-loops */
  OPT_funroll_loops = 920,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 921,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 922,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 923,             /* -funsigned-bitfields */
  OPT_funsigned_char = 924,                  /* -funsigned-char */
  OPT_funswitch_loops = 925,                 /* -funswitch-loops */
  OPT_funwind_tables = 926,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 927,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 928,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 929,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 930,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 931,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 932,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 933,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 934,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 935,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 936,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 937, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 938,                /* -fvect-cost-model */
  OPT_fverbose_asm = 939,                    /* -fverbose-asm */
  /* OPT_fversion = 940, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 941,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 942,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 943,                    /* -fvisibility= */
  OPT_fvpt = 944,                            /* -fvpt */
  /* OPT_fvtable_gc = 945, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 946, */            /* -fvtable-thunks */
  OPT_fweak = 947,                           /* -fweak */
  OPT_fweb = 948,                            /* -fweb */
  OPT_fwhole_file = 949,                     /* -fwhole-file */
  OPT_fwhole_program = 950,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 951,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 952,              /* -fworking-directory */
  OPT_fwpa = 953,                            /* -fwpa */
  OPT_fwrapv = 954,                          /* -fwrapv */
  /* OPT_fxref = 955, */                     /* -fxref */
  /* OPT_fzee = 956, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 957,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 958,                      /* -fzero-link */
  OPT_g = 959,                               /* -g */
  OPT_gant = 960,                            /* -gant */
  OPT_gcoff = 961,                           /* -gcoff */
  OPT_gdwarf_ = 962,                         /* -gdwarf- */
  OPT_gen_decls = 963,                       /* -gen-decls */
  OPT_ggdb = 964,                            /* -ggdb */
  OPT_gnat = 965,                            /* -gnat */
  OPT_gnatO = 966,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 967,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 968,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 969,            /* -grecord-gcc-switches */
  OPT_gstabs = 970,                          /* -gstabs */
  OPT_gstabs_ = 971,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 972,                   /* -gstrict-dwarf */
  OPT_gtoggle = 973,                         /* -gtoggle */
  OPT_gvms = 974,                            /* -gvms */
  OPT_gxcoff = 975,                          /* -gxcoff */
  OPT_gxcoff_ = 976,                         /* -gxcoff+ */
  OPT_h = 977,                               /* -h */
  OPT_idirafter = 978,                       /* -idirafter */
  OPT_imacros = 979,                         /* -imacros */
  OPT_imultilib = 980,                       /* -imultilib */
  OPT_include = 981,                         /* -include */
  OPT_iplugindir_ = 982,                     /* -iplugindir= */
  OPT_iprefix = 983,                         /* -iprefix */
  OPT_iquote = 984,                          /* -iquote */
  OPT_isysroot = 985,                        /* -isysroot */
  OPT_isystem = 986,                         /* -isystem */
  OPT_iwithprefix = 987,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 988,               /* -iwithprefixbefore */
  OPT_k8 = 989,                              /* -k8 */
  OPT_l = 990,                               /* -l */
  OPT_lang_asm = 991,                        /* -lang-asm */
  OPT_mabi_ = 992,                           /* -mabi= */
  OPT_mabort_on_noreturn = 993,              /* -mabort-on-noreturn */
  OPT_mandroid = 994,                        /* -mandroid */
  OPT_mapcs = 995,                           /* -mapcs */
  OPT_mapcs_float = 996,                     /* -mapcs-float */
  OPT_mapcs_frame = 997,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 998,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 999,               /* -mapcs-stack-check */
  OPT_march_ = 1000,                         /* -march= */
  OPT_marm = 1001,                           /* -marm */
  OPT_mbig_endian = 1002,                    /* -mbig-endian */
  OPT_mbionic = 1003,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1004,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1005,     /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 1006,      /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 1007,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1008,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1009,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1010,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1011, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1012, */                    /* -mfp=3 */
  OPT_mfpe = 1013,                           /* -mfpe */
  /* OPT_mfpe_2 = 1014, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1015, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1016,                          /* -mfpu= */
  OPT_mglibc = 1017,                         /* -mglibc */
  ...
  OPT_std_gnu__1y = 1107,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1108,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1109,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1110, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1111, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1112,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1113,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1114, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1115, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1116,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1117, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1118, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1119, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1120,                     /* -std=legacy */
  OPT_symbolic = 1121,                       /* -symbolic */
  OPT_t = 1122,                              /* -t */
  OPT_time = 1123,                           /* -time */
  OPT_time_ = 1124,                          /* -time= */
  OPT_tno_android_cc = 1125,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1126,                 /* -tno-android-ld */
  OPT_traditional = 1127,                    /* -traditional */
  OPT_traditional_cpp = 1128,                /* -traditional-cpp */
  OPT_trigraphs = 1129,                      /* -trigraphs */
  OPT_u = 1130,                              /* -u */
  OPT_undef = 1131,                          /* -undef */
  OPT_v = 1132,                              /* -v */
  OPT_version = 1133,                        /* -version */
  OPT_w = 1134,                              /* -w */
  OPT_wrapper = 1135,                        /* -wrapper */
  OPT_x = 1136,                              /* -x */
  OPT_z = 1137,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
