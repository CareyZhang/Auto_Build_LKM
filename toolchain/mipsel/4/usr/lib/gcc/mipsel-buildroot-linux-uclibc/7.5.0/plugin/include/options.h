...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 998, */     /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 999,          /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1000, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1001,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1002, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1003,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1004,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1005,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1006, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1007,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1008,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1009,                   /* -ftime-report */
  OPT_ftime_report_details = 1010,           /* -ftime-report-details */
  OPT_ftls_model_ = 1011,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1012,              /* -ftoplevel-reorder */
  OPT_ftracer = 1013,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1014,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1015,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1016,                   /* -ftrampolines */
  OPT_ftrapping_math = 1017,                 /* -ftrapping-math */
  OPT_ftrapv = 1018,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1019,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1020,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1021,                      /* -ftree-ccp */
  OPT_ftree_ch = 1022,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1023, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1024,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1025,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1026, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1027,                   /* -ftree-cselim */
  OPT_ftree_dce = 1028,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1029,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1030,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1031,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1032,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1033, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1034,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1035,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1036, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1037,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1038,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1039, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1040,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1041,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1042,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1043,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1044,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1045,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1046,                      /* -ftree-pre */
  OPT_ftree_pta = 1047,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1048,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1049, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1050,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1051,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1052,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1053,                     /* -ftree-slsr */
  OPT_ftree_sra = 1054,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1055, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1056, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1057,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1058,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1059,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1060, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1061,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1062, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1063,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1064,         /* -funconstrained-commons */
  OPT_funderscoring = 1065,                  /* -funderscoring */
  OPT_funit_at_a_time = 1066,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1067,              /* -funroll-all-loops */
  OPT_funroll_loops = 1068,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1069, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1070,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1071,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1072,                 /* -funsigned-char */
  OPT_funswitch_loops = 1073,                /* -funswitch-loops */
  OPT_funwind_tables = 1074,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1075,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1076,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1077,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1078,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1079,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1080,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1081,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1082,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1083,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1084,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1085, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1086,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1087,                   /* -fverbose-asm */
  /* OPT_fversion = 1088, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1089,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1090,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1091,                   /* -fvisibility= */
  OPT_fvpt = 1092,                           /* -fvpt */
  /* OPT_fvtable_gc = 1093, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1094, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1095,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1096,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1097,                     /* -fvtv-debug */
  OPT_fweak = 1098,                          /* -fweak */
  OPT_fweb = 1099,                           /* -fweb */
  /* OPT_fwhole_file = 1100, */              /* -fwhole-file */
  OPT_fwhole_program = 1101,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1102,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1103,             /* -fworking-directory */
  OPT_fwpa = 1104,                           /* -fwpa */
  OPT_fwpa_ = 1105,                          /* -fwpa= */
  OPT_fwrapv = 1106,                         /* -fwrapv */
  /* OPT_fxref = 1107, */                    /* -fxref */
  /* OPT_fzee = 1108, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1109,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1110,                     /* -fzero-link */
  OPT_g = 1111,                              /* -g */
  OPT_gant = 1112,                           /* -gant */
  OPT_gcoff = 1113,                          /* -gcoff */
  OPT_gcolumn_info = 1114,                   /* -gcolumn-info */
  OPT_gdwarf = 1115,                         /* -gdwarf */
  OPT_gdwarf_ = 1116,                        /* -gdwarf- */
  OPT_gen_decls = 1117,                      /* -gen-decls */
  OPT_ggdb = 1118,                           /* -ggdb */
  OPT_ggnu_pubnames = 1119,                  /* -ggnu-pubnames */
  OPT_gnat = 1120,                           /* -gnat */
  OPT_gnatO = 1121,                          /* -gnatO */
  OPT_gno_column_info = 1122,                /* -gno-column-info */
  OPT_gno_pubnames = 1123,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1124,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1125,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1126,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1127,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1128,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1129,                   /* -gsplit-dwarf */
  OPT_gstabs = 1130,                         /* -gstabs */
  OPT_gstabs_ = 1131,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1132,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1133,                        /* -gtoggle */
  OPT_gvms = 1134,                           /* -gvms */
  OPT_gxcoff = 1135,                         /* -gxcoff */
  OPT_gxcoff_ = 1136,                        /* -gxcoff+ */
  OPT_gz = 1137,                             /* -gz */
  OPT_gz_ = 1138,                            /* -gz= */
  OPT_h = 1139,                              /* -h */
  OPT_idirafter = 1140,                      /* -idirafter */
  OPT_imacros = 1141,                        /* -imacros */
  OPT_imultiarch = 1142,                     /* -imultiarch */
  OPT_imultilib = 1143,                      /* -imultilib */
  OPT_include = 1144,                        /* -include */
  OPT_iplugindir_ = 1145,                    /* -iplugindir= */
  OPT_iprefix = 1146,                        /* -iprefix */
  OPT_iquote = 1147,                         /* -iquote */
  OPT_isysroot = 1148,                       /* -isysroot */
  OPT_isystem = 1149,                        /* -isystem */
  OPT_iwithprefix = 1150,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1151,              /* -iwithprefixbefore */
  OPT_k8 = 1152,                             /* -k8 */
  OPT_l = 1153,                              /* -l */
  OPT_lang_asm = 1154,                       /* -lang-asm */
  OPT_mabi_ = 1155,                          /* -mabi= */
  OPT_mabicalls = 1156,                      /* -mabicalls */
  OPT_mabs_ = 1157,                          /* -mabs= */
  OPT_mandroid = 1158,                       /* -mandroid */
  OPT_march_ = 1159,                         /* -march= */
  OPT_mbionic = 1160,                        /* -mbionic */
  OPT_mbranch_cost_ = 1161,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1162,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1163,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1164,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1165,             /* -mcompact-branches= */
  OPT_mdebug = 1166,                         /* -mdebug */
  OPT_mdebugd = 1167,                        /* -mdebugd */
  OPT_mdivide_breaks = 1168,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1169,                  /* -mdivide-traps */
  OPT_mdmx = 1170,                           /* -mdmx */
  OPT_mdouble_float = 1171,                  /* -mdouble-float */
  OPT_mdsp = 1172,                           /* -mdsp */
  OPT_mdspr2 = 1173,                         /* -mdspr2 */
  OPT_meb = 1174,                            /* -meb */
  OPT_mel = 1175,                            /* -mel */
  OPT_membedded_data = 1176,                 /* -membedded-data */
  OPT_meva = 1177,                           /* -meva */
  OPT_mexplicit_relocs = 1178,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1179,                  /* -mextern-sdata */
  OPT_mfix_24k = 1180,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1181,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1182,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1183,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1184,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1185,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1186,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1187,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1188,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1189,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1190,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1191,                 /* -mfp-exceptions */
  OPT_mfp32 = 1192,                          /* -mfp32 */
  OPT_mfp64 = 1193,                          /* -mfp64 */
  OPT_mfpxx = 1194,                          /* -mfpxx */
  OPT_mframe_header_opt = 1195,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1196, */              /* -mfused-madd */
  OPT_mglibc = 1197,                         /* -mglibc */
  OPT_mgp32 = 1198,                          /* -mgp32 */
  OPT_mgp64 = 1199,                          /* -mgp64 */
  OPT_mgpopt = 1200,                         /* -mgpopt */
  OPT_mhard_float = 1201,                    /* -mhard-float */
  OPT_mimadd = 1202,                         /* -mimadd */
  OPT_minterlink_compressed = 1203,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1204,              /* -minterlink-mips16 */
  OPT_mips = 1205,                           /* -mips */
  OPT_mips16 = 1206,                         /* -mips16 */
  OPT_mips3d = 1207,                         /* -mips3d */
  OPT_mllsc = 1208,                          /* -mllsc */
  OPT_mload_store_pairs = 1209,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1210,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1211,                    /* -mlong-calls */
  OPT_mlong32 = 1212,                        /* -mlong32 */
  OPT_mlong64 = 1213,                        /* -mlong64 */
  OPT_mlra = 1214,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1215,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1216,                           /* -mmad */
  OPT_mmadd4 = 1217,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1218,             /* -mmcount-ra-address */
  OPT_mmcu = 1219,                           /* -mmcu */
  OPT_mmemcpy = 1220,                        /* -mmemcpy */
  OPT_mmicromips = 1221,                     /* -mmicromips */
  OPT_mmsa = 1222,                           /* -mmsa */
  OPT_mmt = 1223,                            /* -mmt */
  OPT_mmusl = 1224,                          /* -mmusl */
  OPT_mnan_ = 1225,                          /* -mnan= */
  OPT_mno_float = 1226,                      /* -mno-float */
  OPT_mno_flush_func = 1227,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1228,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1229,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1230,                     /* -mno-mips3d */
  OPT_modd_spreg = 1231,                     /* -modd-spreg */
  OPT_mpaired_single = 1232,                 /* -mpaired-single */
  OPT_mplt = 1233,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1234,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1235,               /* -mrelax-pic-calls */
  OPT_mshared = 1236,                        /* -mshared */
  OPT_msingle_float = 1237,                  /* -msingle-float */
  OPT_msmartmips = 1238,                     /* -msmartmips */
  OPT_msoft_float = 1239,                    /* -msoft-float */
  OPT_msplit_addresses = 1240,               /* -msplit-addresses */
  OPT_msym32 = 1241,                         /* -msym32 */
  OPT_msynci = 1242,                         /* -msynci */
  OPT_mtune_ = 1243,                         /* -mtune= */
  OPT_muclibc = 1244,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1245,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1246,                          /* -mvirt */
  OPT_mvr4130_align = 1247,                  /* -mvr4130-align */
  OPT_mxgot = 1248,                          /* -mxgot */
  OPT_mxpa = 1249,                           /* -mxpa */
  OPT_n = 1250,                              /* -n */
  OPT_no_canonical_prefixes = 1251,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1252,              /* -no-integrated-cpp */
  OPT_no_pie = 1253,                         /* -no-pie */
  OPT_noasmopt = 1254,                       /* -noasmopt */
  OPT_nocpp = 1255,                          /* -nocpp */
  OPT_nodefaultlibs = 1256,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1257,                   /* -nostartfiles */
  OPT_nostdinc = 1258,                       /* -nostdinc */
  OPT_nostdinc__ = 1259,                     /* -nostdinc++ */
  OPT_nostdlib = 1260,                       /* -nostdlib */
  OPT_o = 1261,                              /* -o */
  OPT_p = 1262,                              /* -p */
  OPT_pass_exit_codes = 1263,                /* -pass-exit-codes */
  /* OPT_pedantic = 1264, */                 /* -pedantic */
  OPT_pedantic_errors = 1265,                /* -pedantic-errors */
  OPT_pg = 1266,                             /* -pg */
  OPT_pie = 1267,                            /* -pie */
  OPT_pipe = 1268,                           /* -pipe */
  OPT_posix = 1269,                          /* -posix */
  OPT_print_file_name_ = 1270,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1271,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1272,          /* -print-multi-directory */
  OPT_print_multi_lib = 1273,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1274,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1275,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1276,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1277,               /* -print-prog-name= */
  OPT_print_search_dirs = 1278,              /* -print-search-dirs */
  OPT_print_sysroot = 1279,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1280,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1281,                        /* -profile */
  OPT_pthread = 1282,                        /* -pthread */
  OPT_quiet = 1283,                          /* -quiet */
  OPT_r = 1284,                              /* -r */
  OPT_rdynamic = 1285,                       /* -rdynamic */
  OPT_remap = 1286,                          /* -remap */
  OPT_s = 1287,                              /* -s */
  OPT_save_temps = 1288,                     /* -save-temps */
  OPT_save_temps_ = 1289,                    /* -save-temps= */
  OPT_shared = 1290,                         /* -shared */
  OPT_shared_libgcc = 1291,                  /* -shared-libgcc */
  /* OPT_specs = 1292, */                    /* -specs */
  OPT_specs_ = 1293,                         /* -specs= */
  OPT_static = 1294,                         /* -static */
  OPT_static_libasan = 1295,                 /* -static-libasan */
  OPT_static_libgcc = 1296,                  /* -static-libgcc */
  OPT_static_libgfortran = 1297,             /* -static-libgfortran */
  OPT_static_libgo = 1298,                   /* -static-libgo */
  OPT_static_liblsan = 1299,                 /* -static-liblsan */
  OPT_static_libmpx = 1300,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1301,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1302,               /* -static-libstdc++ */
  OPT_static_libtsan = 1303,                 /* -static-libtsan */
  OPT_static_libubsan = 1304,                /* -static-libubsan */
  /* OPT_std_c__03 = 1305, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1306, */                /* -std=c++0x */
  OPT_std_c__11 = 1307,                      /* -std=c++11 */
  OPT_std_c__14 = 1308,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1309, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1310, */                /* -std=c++1y */
  OPT_std_c__1z = 1311,                      /* -std=c++1z */
  OPT_std_c__98 = 1312,                      /* -std=c++98 */
  OPT_std_c11 = 1313,                        /* -std=c11 */
  /* OPT_std_c1x = 1314, */                  /* -std=c1x */
  /* OPT_std_c89 = 1315, */                  /* -std=c89 */
  OPT_std_c90 = 1316,                        /* -std=c90 */
  OPT_std_c99 = 1317,                        /* -std=c99 */
  /* OPT_std_c9x = 1318, */                  /* -std=c9x */
  OPT_std_f2003 = 1319,                      /* -std=f2003 */
  OPT_std_f2008 = 1320,                      /* -std=f2008 */
  OPT_std_f2008ts = 1321,                    /* -std=f2008ts */
