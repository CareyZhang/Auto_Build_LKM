...
enum opt_code
{
  ...
  OPT_Wc_binding_type = 179,                 /* -Wc-binding-type */
  ...
  OPT_Wliteral_suffix = 260,                 /* -Wliteral-suffix */
  OPT_Wlocal_hiding = 261,                   /* -Wlocal-hiding */
  OPT_Wlogical_op = 262,                     /* -Wlogical-op */
  OPT_Wlong_long = 263,                      /* -Wlong-long */
  OPT_Wmain = 264,                           /* -Wmain */
  OPT_Wmasked_catch_block = 265,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 266,            /* -Wmaybe-uninitialized */
  OPT_Wmissing_braces = 267,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 268,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 269,     /* -Wmissing-field-initializers */
  OPT_Wmissing_format_attribute = 270,       /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 271,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 272, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 273,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 274,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 275,                        /* -Wmudflap */
  OPT_Wmultichar = 276,                      /* -Wmultichar */
  OPT_Wnarrowing = 277,                      /* -Wnarrowing */
  OPT_Wnested_externs = 278,                 /* -Wnested-externs */
  OPT_Wnls = 279,                            /* -Wnls */
  OPT_Wno_effect_assign = 280,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 281,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 282,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 283,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 284,                        /* -Wnonnull */
  OPT_Wnormalized_ = 285,                    /* -Wnormalized= */
  OPT_Wnull = 286,                           /* -Wnull */
  OPT_Wold_style_cast = 287,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 288,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 289,           /* -Wold-style-definition */
  OPT_Wout_of_date = 290,                    /* -Wout-of-date */
  OPT_Wover_ann = 291,                       /* -Wover-ann */
  OPT_Woverflow = 292,                       /* -Woverflow */
  OPT_Woverlength_strings = 293,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 294,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 295,                  /* -Woverride-init */
  OPT_Wp_ = 296,                             /* -Wp, */
  OPT_Wpacked = 297,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 298,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 299,                         /* -Wpadded */
  OPT_Wparam_assign = 300,                   /* -Wparam-assign */
  OPT_Wparentheses = 301,                    /* -Wparentheses */
  OPT_Wpedantic = 302,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 303,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 304,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 305,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 306,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 307,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 308,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 309,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 310,                       /* -Wprotocol */
  OPT_Wpsabi = 311,                          /* -Wpsabi */
  OPT_Wraw = 312,                            /* -Wraw */
  OPT_Wreal_q_constant = 313,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 314,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 315,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 316,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 317,            /* -Wredundant-modifiers */
  OPT_Wreorder = 318,                        /* -Wreorder */
  OPT_Wreturn_type = 319,                    /* -Wreturn-type */
  OPT_Wselector = 320,                       /* -Wselector */
  OPT_Wsequence_point = 321,                 /* -Wsequence-point */
  OPT_Wserial = 322,                         /* -Wserial */
  OPT_Wshadow = 323,                         /* -Wshadow */
  OPT_Wsign_compare = 324,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 325,                /* -Wsign-conversion */
  OPT_Wsign_promo = 326,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 327,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 328,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 329,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 330,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 331,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 332,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 333,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 334,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 335,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 336,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 337,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 338,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 339,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 340,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 341,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 342,                       /* -Wsuppress */
  OPT_Wsurprising = 343,                     /* -Wsurprising */
  OPT_Wswitch = 344,                         /* -Wswitch */
  OPT_Wswitch_default = 345,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 346,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 347,                      /* -Wsync-nand */
  OPT_Wsynth = 348,                          /* -Wsynth */
  OPT_Wsynthetic_access = 349,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 350,                 /* -Wsystem-headers */
  OPT_Wtabs = 351,                           /* -Wtabs */
  OPT_Wtasks = 352,                          /* -Wtasks */
  ...
  OPT_Wunused_local_typedefs = 379,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 380,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 381,               /* -Wunused-parameter */
  OPT_Wunused_private = 382,                 /* -Wunused-private */
  OPT_Wunused_result = 383,                  /* -Wunused-result */
  OPT_Wunused_thrown = 384,                  /* -Wunused-thrown */
  OPT_Wunused_value = 385,                   /* -Wunused-value */
  OPT_Wunused_variable = 386,                /* -Wunused-variable */
  OPT_Wuseless_cast = 387,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 388,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 389,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 390,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 391,   /* -Wvector-operation-performance */
  OPT_Wvla = 392,                            /* -Wvla */
  ...
  OPT_Wzero_as_null_pointer_constant = 396,  /* -Wzero-as-null-pointer-constant */
  OPT_Xassembler = 397,                      /* -Xassembler */
  OPT_Xlinker = 398,                         /* -Xlinker */
  OPT_Xpreprocessor = 399,                   /* -Xpreprocessor */
  OPT_Z = 400,                               /* -Z */
  OPT_ansi = 401,                            /* -ansi */
  OPT_aux_info = 402,                        /* -aux-info */
  /* OPT_aux_info_ = 403, */                 /* -aux-info= */
  OPT_auxbase = 404,                         /* -auxbase */
  OPT_auxbase_strip = 405,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 406, */             /* -bootclasspath */
  OPT_c = 407,                               /* -c */
  ...
  OPT_faggressive_function_elimination = 428,/* -faggressive-function-elimination */
  OPT_falign_commons = 429,                  /* -falign-commons */
  OPT_falign_functions = 430,                /* -falign-functions */
  OPT_falign_functions_ = 431,               /* -falign-functions= */
  OPT_falign_jumps = 432,                    /* -falign-jumps */
  OPT_falign_jumps_ = 433,                   /* -falign-jumps= */
  OPT_falign_labels = 434,                   /* -falign-labels */
  OPT_falign_labels_ = 435,                  /* -falign-labels= */
  OPT_falign_loops = 436,                    /* -falign-loops */
  OPT_falign_loops_ = 437,                   /* -falign-loops= */
  OPT_fall_intrinsics = 438,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 439, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 440,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 441,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 442, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 443, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 444, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 445, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 446, */  /* -fargument-noalias-global */
  OPT_fasm = 447,                            /* -fasm */
  OPT_fassert = 448,                         /* -fassert */
  OPT_fassociative_math = 449,               /* -fassociative-math */
  OPT_fassume_compiled = 450,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 451,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 452,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 453,                   /* -fauto-inc-dec */
  OPT_fautomatic = 454,                      /* -fautomatic */
  OPT_faux_classpath = 455,                  /* -faux-classpath */
  OPT_fbackslash = 456,                      /* -fbackslash */
  OPT_fbacktrace = 457,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 458,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 459,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 460,              /* -fbootstrap-classes */
  OPT_fbounds_check = 461,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 462,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 463,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 464,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 465,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 466,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 467,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 468,                        /* -fbuiltin */
  OPT_fbuiltin_ = 469,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 470,                    /* -fcall-saved- */
  OPT_fcall_used_ = 471,                     /* -fcall-used- */
  OPT_fcaller_saves = 472,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 473,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 474,                /* -fcheck-data-deps */
  OPT_fcheck_new = 475,                      /* -fcheck-new */
  OPT_fcheck_references = 476,               /* -fcheck-references */
  OPT_fcheck_ = 477,                         /* -fcheck= */
  OPT_fclasspath_ = 478,                     /* -fclasspath= */
  OPT_fcoarray_ = 479,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 480,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 481,                         /* -fcommon */
  OPT_fcompare_debug = 482,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 483,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 484,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 485,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 486,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 487,                  /* -fcond-mismatch */
  OPT_fconserve_space = 488,                 /* -fconserve-space */
  OPT_fconserve_stack = 489,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 490,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 491,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 492,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 493,          /* -fconvert=little-endian */
  OPT_fconvert_native = 494,                 /* -fconvert=native */
  OPT_fconvert_swap = 495,                   /* -fconvert=swap */
  OPT_fcprop_registers = 496,                /* -fcprop-registers */
  OPT_fcray_pointer = 497,                   /* -fcray-pointer */
  OPT_fcrossjumping = 498,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 499,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 500, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 501,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 502,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 503,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 504,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 505,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 506,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 507,                       /* -fdbg-cnt= */
  OPT_fdce = 508,                            /* -fdce */
  OPT_fdebug_cpp = 509,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 510,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 511,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 512,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 513,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 514, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 515,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 516,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 517,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 518,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 519,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 520,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 521,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 522,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 523,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 524,                /* -fdirectives-only */
  OPT_fdisable_ = 525,                       /* -fdisable- */
  OPT_fdisable_assertions = 526,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 527,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 528,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 529,         /* -fdollars-in-identifiers */
  OPT_fdse = 530,                            /* -fdse */
  OPT_fdump_ = 531,                          /* -fdump- */
  /* OPT_fdump_core = 532, */                /* -fdump-core */
  OPT_fdump_final_insns = 533,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 534,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 535,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 536,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 537,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 538,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 539,                /* -fdump-parse-tree */
  OPT_fdump_passes = 540,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 541,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 542,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 543,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 544,                 /* -fearly-inlining */
  OPT_felide_constructors = 545,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 546,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 547, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 548,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 549,        /* -femit-class-debug-always */
  OPT_femit_class_file = 550,                /* -femit-class-file */
  OPT_femit_class_files = 551,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 552,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 553,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 554,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 555,                        /* -fenable- */
  OPT_fenable_assertions = 556,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 557,             /* -fenable-assertions= */
  OPT_fencoding_ = 558,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 559,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 560, */           /* -fenum-int-equiv */
  OPT_fexceptions = 561,                     /* -fexceptions */
  OPT_fexcess_precision_ = 562,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 563,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 564,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 565,                       /* -fextdirs= */
  OPT_fextended_identifiers = 566,           /* -fextended-identifiers */
  OPT_fexternal_blas = 567,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 568, */       /* -fexternal-templates */
  OPT_ff2c = 569,                            /* -ff2c */
  OPT_ffast_math = 570,                      /* -ffast-math */
  OPT_ffat_lto_objects = 571,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 572,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 573,               /* -ffinite-math-only */
  OPT_ffixed_ = 574,                         /* -ffixed- */
  OPT_ffixed_form = 575,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 576,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 577,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 578,                    /* -ffloat-store */
  OPT_ffor_scope = 579,                      /* -ffor-scope */
  /* OPT_fforce_addr = 580, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 581,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 582,              /* -fforward-propagate */
  OPT_ffp_contract_ = 583,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 584,                      /* -ffpe-trap= */
  OPT_ffree_form = 585,                      /* -ffree-form */
  OPT_ffree_line_length_ = 586,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 587,          /* -ffree-line-length-none */
  OPT_ffreestanding = 588,                   /* -ffreestanding */
  OPT_ffriend_injection = 589,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 590,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 591,                   /* -ffunction-cse */
  OPT_ffunction_sections = 592,              /* -ffunction-sections */
  OPT_fgcse = 593,                           /* -fgcse */
  OPT_fgcse_after_reload = 594,              /* -fgcse-after-reload */
  OPT_fgcse_las = 595,                       /* -fgcse-las */
  OPT_fgcse_lm = 596,                        /* -fgcse-lm */
  OPT_fgcse_sm = 597,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 598,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 599,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 600,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 601,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 602,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 603,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 604,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 605,                   /* -fgo-optimize- */
  OPT_fgo_prefix_ = 606,                     /* -fgo-prefix= */
  OPT_fgraphite = 607,                       /* -fgraphite */
  OPT_fgraphite_identity = 608,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 609,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 610, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 611, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 612,           /* -fhash-synchronization */
  /* OPT_fhelp = 613, */                     /* -fhelp */
  /* OPT_fhelp_ = 614, */                    /* -fhelp= */
  /* OPT_fhonor_std = 615, */                /* -fhonor-std */
  OPT_fhosted = 616,                         /* -fhosted */
  /* OPT_fhuge_objects = 617, */             /* -fhuge-objects */
  OPT_fident = 618,                          /* -fident */
  OPT_fif_conversion = 619,                  /* -fif-conversion */
  OPT_fif_conversion2 = 620,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 621,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 622,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 623,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 624,             /* -fimplicit-templates */
  OPT_findirect_classes = 625,               /* -findirect-classes */
  OPT_findirect_dispatch = 626,              /* -findirect-dispatch */
  OPT_findirect_inlining = 627,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 628,         /* -finhibit-size-directive */
  OPT_finit_character_ = 629,                /* -finit-character= */
  OPT_finit_integer_ = 630,                  /* -finit-integer= */
  OPT_finit_local_zero = 631,                /* -finit-local-zero */
  OPT_finit_logical_ = 632,                  /* -finit-logical= */
  OPT_finit_real_ = 633,                     /* -finit-real= */
  OPT_finline = 634,                         /* -finline */
  OPT_finline_atomics = 635,                 /* -finline-atomics */
  OPT_finline_functions = 636,               /* -finline-functions */
  OPT_finline_functions_called_once = 637,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 638, */            /* -finline-limit- */
  OPT_finline_limit_ = 639,                  /* -finline-limit= */
  OPT_finline_small_functions = 640,         /* -finline-small-functions */
  OPT_finput_charset_ = 641,                 /* -finput-charset= */
  ...
  OPT_fprotect_parens = 762,                 /* -fprotect-parens */
  OPT_frandom_seed = 763,                    /* -frandom-seed */
  OPT_frandom_seed_ = 764,                   /* -frandom-seed= */
  OPT_frange_check = 765,                    /* -frange-check */
  OPT_freal_4_real_10 = 766,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 767,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 768,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 769,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 770,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 771,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 772,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 773,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 774,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 775,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 776,                /* -frecord-marker=8 */
  OPT_frecursive = 777,                      /* -frecursive */
  OPT_freduced_reflection = 778,             /* -freduced-reflection */
  OPT_free = 779,                            /* -free */
  OPT_freg_struct_return = 780,              /* -freg-struct-return */
  OPT_fregmove = 781,                        /* -fregmove */
  ...
  OPT_fsched_pressure_algorithm_ = 803,      /* -fsched-pressure-algorithm= */
  OPT_fsched_rank_heuristic = 804,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 805,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 806,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 807,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 808,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 809,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 810,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 811,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 812,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 813,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 814,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 815, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 816,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 817,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 818,              /* -fsecond-underscore */
  OPT_fsection_anchors = 819,                /* -fsection-anchors */
  /* OPT_fsee = 820, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 821,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 822,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 823, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 824,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 825,          /* -fselective-scheduling2 */
  OPT_fshort_double = 826,                   /* -fshort-double */
  OPT_fshort_enums = 827,                    /* -fshort-enums */
  OPT_fshort_wchar = 828,                    /* -fshort-wchar */
  OPT_fshow_column = 829,                    /* -fshow-column */
  OPT_fshrink_wrap = 830,                    /* -fshrink-wrap */
  OPT_fsign_zero = 831,                      /* -fsign-zero */
  OPT_fsignaling_nans = 832,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 833,               /* -fsigned-bitfields */
  OPT_fsigned_char = 834,                    /* -fsigned-char */
  OPT_fsigned_zeros = 835,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 836,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 837,               /* -fsource-filename= */
  OPT_fsource_ = 838,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 839,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 840,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 841,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 842, */                 /* -fsquangle */
  OPT_fstack_arrays = 843,                   /* -fstack-arrays */
  /* OPT_fstack_check = 844, */              /* -fstack-check */
  OPT_fstack_check_ = 845,                   /* -fstack-check= */
  OPT_fstack_limit = 846,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 847,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 848,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 849,                /* -fstack-protector */
  OPT_fstack_protector_all = 850,            /* -fstack-protector-all */
  OPT_fstack_usage = 851,                    /* -fstack-usage */
  OPT_fstats = 852,                          /* -fstats */
  OPT_fstore_check = 853,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 854, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 855,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 856,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 857,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 858, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 859,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 860,                    /* -fsyntax-only */
  OPT_ftabstop_ = 861,                       /* -ftabstop= */
  /* OPT_ftarget_help = 862, */              /* -ftarget-help */
  OPT_ftarget_ = 863,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 864,      /* -ftemplate-backtrace-limit= */
  ...
  OPT_ftree_loop_distribute_patterns = 891,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 892,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 893,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 894,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 895,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 896,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 897, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 898,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 899,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 900,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 901,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 902,                   /* -ftree-phiprop */
  OPT_ftree_pre = 903,                       /* -ftree-pre */
  OPT_ftree_pta = 904,                       /* -ftree-pta */
  OPT_ftree_reassoc = 905,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 906, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 907,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 908,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 909,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 910,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 911, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 912, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 913,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 914,                /* -ftree-tail-merge */
  OPT_ftree_ter = 915,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 916,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 917,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 918,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 919,                       /* -ftree-vrp */
  OPT_funderscoring = 920,                   /* -funderscoring */
  OPT_funit_at_a_time = 921,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 922,               /* -funroll-all-loops */
  OPT_funroll_loops = 923,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 924,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 925,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 926,             /* -funsigned-bitfields */
  OPT_funsigned_char = 927,                  /* -funsigned-char */
  OPT_funswitch_loops = 928,                 /* -funswitch-loops */
  OPT_funwind_tables = 929,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 930,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 931,                   /* -fuse-boehm-gc */
  ...
  OPT_mabi_ = 995,                           /* -mabi= */
  OPT_mabicalls = 996,                       /* -mabicalls */
  OPT_mad = 997,                             /* -mad */
  OPT_mandroid = 998,                        /* -mandroid */
  OPT_march_ = 999,                          /* -march= */
  OPT_mbionic = 1000,                        /* -mbionic */
  OPT_mbranch_cost_ = 1001,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1002,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1003,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1004,                /* -mcode-readable= */
  OPT_mdebug = 1005,                         /* -mdebug */
  OPT_mdebugd = 1006,                        /* -mdebugd */
  OPT_mdivide_breaks = 1007,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1008,                  /* -mdivide-traps */
  OPT_mdmx = 1009,                           /* -mdmx */
  OPT_mdouble_float = 1010,                  /* -mdouble-float */
  OPT_mdsp = 1011,                           /* -mdsp */
  OPT_mdspr2 = 1012,                         /* -mdspr2 */
  OPT_meb = 1013,                            /* -meb */
  OPT_mel = 1014,                            /* -mel */
  OPT_membedded_data = 1015,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1016,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1017,                  /* -mextern-sdata */
  OPT_mfix_24k = 1018,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1019,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1020,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1021,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1022,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1023,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1024,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1025,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1026,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1027,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1028,                 /* -mfp-exceptions */
  OPT_mfp32 = 1029,                          /* -mfp32 */
  OPT_mfp64 = 1030,                          /* -mfp64 */
  OPT_mfused_madd = 1031,                    /* -mfused-madd */
  OPT_mglibc = 1032,                         /* -mglibc */
  OPT_mgp32 = 1033,                          /* -mgp32 */
  OPT_mgp64 = 1034,                          /* -mgp64 */
  OPT_mgpopt = 1035,                         /* -mgpopt */
  OPT_mhard_float = 1036,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1037,              /* -minterlink-mips16 */
  OPT_mips = 1038,                           /* -mips */
  OPT_mips16 = 1039,                         /* -mips16 */
  OPT_mips3d = 1040,                         /* -mips3d */
  OPT_mllsc = 1041,                          /* -mllsc */
  OPT_mlocal_sdata = 1042,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1043,                    /* -mlong-calls */
  OPT_mlong32 = 1044,                        /* -mlong32 */
  OPT_mlong64 = 1045,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1046,             /* -mmcount-ra-address */
  OPT_mmemcpy = 1047,                        /* -mmemcpy */
  OPT_mmt = 1048,                            /* -mmt */
  OPT_mno_float = 1049,                      /* -mno-float */
  OPT_mno_flush_func = 1050,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1051,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1052,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1053,                     /* -mno-mips3d */
  OPT_mpaired_single = 1054,                 /* -mpaired-single */
  OPT_mplt = 1055,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1056,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1057,               /* -mrelax-pic-calls */
  OPT_mshared = 1058,                        /* -mshared */
  OPT_msingle_float = 1059,                  /* -msingle-float */
  OPT_msmartmips = 1060,                     /* -msmartmips */
  OPT_msoft_float = 1061,                    /* -msoft-float */
  OPT_msplit_addresses = 1062,               /* -msplit-addresses */
  OPT_msym32 = 1063,                         /* -msym32 */
  OPT_msynci = 1064,                         /* -msynci */
  OPT_mtune_ = 1065,                         /* -mtune= */
  OPT_muclibc = 1066,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1067,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1068,                  /* -mvr4130-align */
  OPT_mxgot = 1069,                          /* -mxgot */
  OPT_n = 1070,                              /* -n */
  OPT_no_canonical_prefixes = 1071,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1072,              /* -no-integrated-cpp */
  OPT_noasmopt = 1073,                       /* -noasmopt */
  OPT_nocpp = 1074,                          /* -nocpp */
  OPT_nodefaultlibs = 1075,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1076,                   /* -nostartfiles */
  OPT_nostdinc = 1077,                       /* -nostdinc */
  OPT_nostdinc__ = 1078,                     /* -nostdinc++ */
  OPT_nostdlib = 1079,                       /* -nostdlib */
  OPT_o = 1080,                              /* -o */
  OPT_p = 1081,                              /* -p */
  OPT_pass_exit_codes = 1082,                /* -pass-exit-codes */
  /* OPT_pedantic = 1083, */                 /* -pedantic */
  OPT_pedantic_errors = 1084,                /* -pedantic-errors */
  OPT_pg = 1085,                             /* -pg */
  OPT_pie = 1086,                            /* -pie */
  OPT_pipe = 1087,                           /* -pipe */
  OPT_posix = 1088,                          /* -posix */
  OPT_print_file_name_ = 1089,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1090,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1091,          /* -print-multi-directory */
  OPT_print_multi_lib = 1092,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1093,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1094,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1095,               /* -print-prog-name= */
  OPT_print_search_dirs = 1096,              /* -print-search-dirs */
  OPT_print_sysroot = 1097,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1098,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1099,                        /* -profile */
  OPT_pthread = 1100,                        /* -pthread */
  OPT_quiet = 1101,                          /* -quiet */
  OPT_r = 1102,                              /* -r */
  OPT_rdynamic = 1103,                       /* -rdynamic */
  OPT_remap = 1104,                          /* -remap */
  OPT_s = 1105,                              /* -s */
  OPT_s_bc_abi = 1106,                       /* -s-bc-abi */
  OPT_save_temps = 1107,                     /* -save-temps */
  OPT_save_temps_ = 1108,                    /* -save-temps= */
  OPT_shared = 1109,                         /* -shared */
  OPT_shared_libgcc = 1110,                  /* -shared-libgcc */
  /* OPT_specs = 1111, */                    /* -specs */
  OPT_specs_ = 1112,                         /* -specs= */
  OPT_static = 1113,                         /* -static */
  OPT_static_libgcc = 1114,                  /* -static-libgcc */
  OPT_static_libgcj = 1115,                  /* -static-libgcj */
  OPT_static_libgfortran = 1116,             /* -static-libgfortran */
  OPT_static_libgo = 1117,                   /* -static-libgo */
  OPT_static_libstdc__ = 1118,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1119, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1120, */                /* -std=c++0x */
  OPT_std_c__11 = 1121,                      /* -std=c++11 */
  OPT_std_c__1y = 1122,                      /* -std=c++1y */
  OPT_std_c__98 = 1123,                      /* -std=c++98 */
  OPT_std_c11 = 1124,                        /* -std=c11 */
  /* OPT_std_c1x = 1125, */                  /* -std=c1x */
  /* OPT_std_c89 = 1126, */                  /* -std=c89 */
  OPT_std_c90 = 1127,                        /* -std=c90 */
  OPT_std_c99 = 1128,                        /* -std=c99 */
  /* OPT_std_c9x = 1129, */                  /* -std=c9x */
  OPT_std_f2003 = 1130,                      /* -std=f2003 */
  OPT_std_f2008 = 1131,                      /* -std=f2008 */
  OPT_std_f2008ts = 1132,                    /* -std=f2008ts */
  OPT_std_f95 = 1133,                        /* -std=f95 */
  OPT_std_gnu = 1134,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1135, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1136, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1137,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1138,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1139,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1140,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1141, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1142, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1143,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1144,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1145, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1146, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1147,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1148, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1149, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1150, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1151,                     /* -std=legacy */
  OPT_symbolic = 1152,                       /* -symbolic */
  OPT_t = 1153,                              /* -t */
  OPT_time = 1154,                           /* -time */
  OPT_time_ = 1155,                          /* -time= */
  OPT_tno_android_cc = 1156,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1157,                 /* -tno-android-ld */
  OPT_traditional = 1158,                    /* -traditional */
  OPT_traditional_cpp = 1159,                /* -traditional-cpp */
  OPT_trigraphs = 1160,                      /* -trigraphs */
  OPT_u = 1161,                              /* -u */
  OPT_undef = 1162,                          /* -undef */
  OPT_v = 1163,                              /* -v */
  OPT_version = 1164,                        /* -version */
  OPT_w = 1165,                              /* -w */
  OPT_wrapper = 1166,                        /* -wrapper */
  OPT_x = 1167,                              /* -x */
  OPT_z = 1168,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
